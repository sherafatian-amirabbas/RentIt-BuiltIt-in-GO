...
func TestGetPlantPrice(t *testing.T) {
	...
	if plantPrice.PricePerDuration != 21 { // for 2 days this is the price, this should be in postgres
...
func TestIsPlantAvailable(t *testing.T) {
	...
	resp, err := http.Get(ApiUrl() + "/plants/IsPlantAvailable/1/2020-03-21/2020-03-22")
	if err != nil {
